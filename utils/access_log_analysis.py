...
def report_channel_counter(cmd=False):
	...
	for (channel,new_user,new_register,all_register,all_user,new_pv,all_pv,new_rate,all_rate) in cursor :
		...
		k=('channel','new_user','new_register','all_register','all_user','new_pv','all_pv','new_rate','all_rate')
		v=(channel,new_user,new_register,all_register,all_user,new_pv,all_pv,new_rate,all_rate)
		vo = dict(zip(k,v))
		j = json.dumps(vo)
