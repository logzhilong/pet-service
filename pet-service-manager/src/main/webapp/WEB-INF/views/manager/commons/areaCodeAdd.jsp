	...
	<div class="pageContent">
		<div class="pageFormContent" layoutH="60">
			<fieldset>
				...
				<dl>
					<select class="combox" name="father" ref="w_comboxcity" refUrl="${ctx }/manager/commons/getConmonArealistBypid.html?pid={value}">
						<option value="all">--请选择国家--</option>
						<c:forEach var="itr" items="${codes }">
	  							<option value="${itr.id }">${itr.name }</option>
	  					</c:forEach>
					</select> 
					<select class="combox" name="pid" id="w_comboxcity">
