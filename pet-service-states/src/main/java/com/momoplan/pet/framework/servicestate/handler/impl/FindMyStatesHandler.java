...
@Component("findMyStates")
public class FindMyStatesHandler extends AbstractHandler{
	...
	public void process(ClientRequest clientRequest,HttpServletResponse response) throws Exception {
		...
		try{
			...
			StateResponse stateResponse = stateService.findMyStates(clientRequest,authenticationToken);
			rtn = new Success(true,stateResponse.getStateViews()).toString();
		}catch(Exception e){
			logger.debug("获取我的动态失败 body="+gson.toJson(clientRequest));
			logger.error("findMyStates : ",e);
